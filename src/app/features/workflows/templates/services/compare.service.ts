...
import { ComparisonResult, CompareFile, CompareEndpoints,
CompareUploadRequest,
CompareStartRequest,
CompareUploadResponse,
CompareStatusResponse } from '../../utils/compareTpl.interface';
...
export class CompareService {
  ...
  configure(config: { useMockData?: boolean; endpoints?: Partial<CompareEndpoints> }): void {
